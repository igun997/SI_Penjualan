 ...
 * @author systemfive
 */
public class v_report_transaksi extends javax.swing.JFrame {
    ...
    /**
     * Creates new form v_report_transaksi
     */
    public v_report_transaksi() {
        initComponents();
        initDate();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        InputStream report = gf.fetch("periode_report_transaksi.jrxml");
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_report_transaksi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_report_transaksi().setVisible(true);
            }
        });
    }
